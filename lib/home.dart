...
import 'package:myflat/favorites_page.dart';
import 'package:myflat/flat.dart';
import 'package:myflat/login_page.dart';
import 'package:myflat/profile-page.dart';
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  void initState() {
    _widgetOptions = <Widget>[
      ...
      MyFavoritesPage(title: "Најди Стан"),
      MyProfilePage(title: "Најди стан", user: widget.user),
    ];
  }
          ...
          Container(
              ...
              child: ListTile(
                leading: ConstrainedBox(
                    ...
                    child: Image.network(_entity.image, fit: BoxFit.cover)),
                title: Text(_entity.title),
                subtitle: Text(_entity.price.toString()),
                trailing: IconButton(
                  icon: Icon(
                    Icons.more_vert,
                    color: Colors.grey,
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => FlatPage(flat: _entity)),
                  );
                },
              ))
        ]));
...
Future<List<City>> fetchCity() async {
  final response = await http.get(Uri.parse(
      'https://myflat-d6495-default-rtdb.europe-west1.firebasedatabase.app/cities.json'));
        ...
        children: <Widget>[
          new SizedBox(
            ...
            child: new DrawerHeader(
              ...
              decoration: BoxDecoration(
                  color: Colors
                      .red /*image: DecorationImage(fit: BoxFit.fill, image: AssetImage('assets/images/cover.jpg'))*/),
            ),
          ),
