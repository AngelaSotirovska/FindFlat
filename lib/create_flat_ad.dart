        ...
        children: <Widget>[
          ...
          Container(
            ...
            items: cities
                .map(
                  (map) =>
                      DropdownMenuItem(child: Text(map.name), value: map.name),
                )
                .toList(),
  ...
  try {
    var response = await http.post(
        ...
        body: json.encode({
          ...
          "Image":
              "https://housinganywhere.imgix.net/room/1822538/8dba65fc-ea8b-4c25-9321-10544e05fdc3.jpg?ixlib=react-9.2.0&auto=format&h=300&w=490"
        }));
